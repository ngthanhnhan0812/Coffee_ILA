...
//     return "discount should contain less than 5";
//   }
//   return null;
// }

  // bool _validateDateRange() {
  //   if (firstDate.text.isEmpty || lastDate.text.isEmpty) {
  //     return false;
  //   }

  //   DateTime startDate = DateTime.parse(firstDate.text);
  //   DateTime endDate = DateTime.parse(lastDate.text);
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            ...
                            child: TextFormField(
                                ...
                                validator: (value) {
                                  ...
                                  if (checkDuplicateId(value, 'ADMIN') ==
                                      'true') {
                                    return 'ngu';
                                  }
                                  return null;
                          ...
                          isDuplicate
                              ? const Text('Voucher code is duplicate!',
